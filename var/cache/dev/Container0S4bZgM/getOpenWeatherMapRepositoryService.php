...
// Returns the private 'App\Repository\OpenWeatherMapRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/OpenWeatherMapRepository.php';

return $this->privates['App\\Repository\\OpenWeatherMapRepository'] = new \App\Repository\OpenWeatherMapRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
